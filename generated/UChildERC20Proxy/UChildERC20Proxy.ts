...
export class UChildERC20Proxy extends ethereum.SmartContract {
  static bind(address: Address): UChildERC20Proxy {
    return new UChildERC20Proxy("UChildERC20Proxy", address);
  }
